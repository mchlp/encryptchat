...
class NewPassphrase extends React.Component {
    ...
    onSubmit = async (e) => {
        ...
        if (
            ...
            const res = await Axios.post('/api/manage/genKeys', {
                passphrase,
                port,
                name,
            });
                ...
                <div className="jumbotron m-5">
                    <form onSubmit={this.onSubmit}>
                        <h1 className="display-4 mb-4">
                            Welcome to EncryptChat!
                        </h1>
                        <p className="lead">
                            Please enter the name you like to be displayed to
                            others.
                        </p>
                        ...
                        <p className="lead">
                            Before you can start chatting, we need to generate
                            your keys to keep your messages secure. Your keys
                            will be locked using a passphrase.
                        </p>
                        <div
                            className="alert alert-danger"
                            id="danger-alert"
                            hidden={!this.state.alert.show}
                        >
                        ...
                        <p className="lead">
                            Please ensure that you remember your passphrase. If
                            you forget it, you will have to regenerate your keys
                            and lose all your past data.
                        </p>
                        ...
                        <LoadingButton
                            ...
                            loading={
                                this.state.submitBtnLoading ? 1 : undefined
                            }
                        >
                            Generate Keys
                        </LoadingButton>
